...
<form action="ano_lectivo/registro.php" method="post">
    <table style="box-shadow: 0 4px 8px 0 rgba(0, 0,0,0.08);  margin-left: 250px; transform: translate(0,30px);" >
        ...
        <h3 style="color: #013f86; text-align: center;">REGISTRO DOS CURSOS</h3>
            <td>Data Fim</td>
            <td><input type="datetime-local" name="fim" id="" placeholder="Digite a primeira nota" required></td>
        </tr>
            <td></td>
...
<button style="transform: translate(0,40px);padding: 10px;   background: #777; color: #fff; border-radius: 5px;    border: 0;cursor: pointer;width: 200px;">
 <a style="text-decoration: none; color: #fff;" href="pdfletivo.php"><i class='bx bxs-edit'></i> pdf</a></button>
...
while($row=$query->fetch_assoc()) {
    ...
    <tr align="center">
        ...
        <td><?= $row['ano'] ?></td>   
        <td align="center">
        <a style="text-decoration: none; color: #777;" href="ano_lectivo/editar.php?editar=<?= $row['codigo']; ?>"><i class='bx bxs-edit'></i> Editar</a>
     <a style="text-decoration: none; color: #777;"  href="ano_lectivo/deletar.php?eleminar=<?= $row['codigo']; ?>"><i class='bx bxs-delete' style="width: 10px;"></i></i><i class='bx bx-x'></i>Deletar</a>

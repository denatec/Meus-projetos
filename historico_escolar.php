...
<form action="historico_escolar/registro.php" method="post">
    <table style="box-shadow: 0 4px 8px 0 rgba(0, 0,0,0.08);  margin-left: 250px; transform: translate(0,30px);" >
     
        <tr >
        <h3 style="color: #013f86; text-align: center;">REGISTRO  Historico Escolar</h3>
        ...
        ?>       
            ...
            <td>
                ...
                <option >seleciona o resultado</option>
        ...
        <tr>
            ...
            <option>escolhe o estudante</option>
            <?php
...
<button style="transform: translate(0,40px);padding: 10px;   background: #777; color: #fff; border-radius: 5px;    border: 0;cursor: pointer;width: 200px;">
 <a style="text-decoration: none; color: #fff;" href="pdfhistorico.php"><i class='bx bxs-edit'></i> pdf</a></button>
...
<div class="search" style="margin-left: 250px;">
    ...
    <?php 
   $sql="SELECT * FROM historico_escolar  AS h INNER JOIN curso AS c ON h.codcurso=c.codigo ";
   ...
   while ($row=$query->fetch_assoc()) {
    ...
    <tr align="center">
        ...
        <td align="center">
        <a style="text-decoration: none; color: #777;" href="historico_escolar/editar.php?editar=<?= $row['codigo']; ?>"><i class='bx bxs-edit'></i> Editar</a>
     <a style="text-decoration: none; color: #777;"  href="historico_escolar/deletar.php?eleminar=<?= $row['codigo']; ?>"><i class='bx bxs-delete' style="width: 10px;"></i></i><i class='bx bx-x'></i>Deletar</a>
 </td>
    </tr>
    <?php 
}

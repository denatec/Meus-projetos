...
<form action="functions/registrocurso.php" method="post">
    <table style="box-shadow: 0 4px 8px 0 rgba(0, 0,0,0.08);  margin-left: 250px; transform: translate(0,30px);" >
        ...
        <h3 style="color: #013f86; text-align: center;">REGISTRO DOS CURSOS</h3>
            <td>Nome</td>
            <td><input type="text" name="nome" id="" placeholder="Digite o nome DO CURSO" required></td>
        </tr>

        <tr>
            <td>Numero Aula</td>
            <td><input type="time" name="aula" id="" placeholder="Digite o numero" required></td>
        </td>
        </tr>
        
        <tr>
            <td>Descrisao</td>
            <td><input type="text" name="descrisao" id="" placeholder="Digite o nome" required></td>
        </td>
        </tr>
...
<button style="transform: translate(0,40px);padding: 10px;   background: #777; color: #fff; border-radius: 5px;    border: 0;cursor: pointer;width: 200px;">
 <a style="text-decoration: none; color: #fff;" href="pdfcurso.php"><i class='bx bxs-edit'></i> pdf</a></button>
...
<div class="search" style="margin-left: 350px;">
    ...
    <?php 
   $sql="SELECT * FROM curso AS c INNER JOIN departamento AS d ON c.coddepartamento=d.codigo";
   ...
   while ($row=$query->fetch_assoc()) {
    ...
    <tr align="center">
        ...
        <td align="center">
    <a style="text-decoration: none; color: #777;" href="functions/editcurso.php?editar=<?= $row['codigo']; ?>"><i class='bx bxs-edit'></i> Editar</a>
     <a style="text-decoration: none; color: #777;"  href="functions/deletecurso.php?eleminar=<?= $row['codigo']; ?>"><i class='bx bxs-delete' style="width: 10px;"></i></i><i class='bx bx-x'></i>Deletar</a>
